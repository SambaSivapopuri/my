...
SECRET_KEY = 'django-insecure-ao&u_(%vn2rhhpga)@!wg76#=r&jxclw-@)y5e0z-ah)^blw^@'
...
#     'default': {
#         'ENGINE': 'djongo',
#         'NAME': 'test',  # Name of your MongoDB database
...
#         'CLIENT': {
#             'host': f"mongodb://{os.environ.get('MONGODB_HOST')}:{os.environ.get('MONGODB_PORT')}/",
#         },
#     }
# }
# DATABASES = {
